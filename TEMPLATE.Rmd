...
```{r, loaddata_show, eval=FALSE}
nancycats <- import2genind("nancycats.gtx")
summary(nancycats)
```

```{r, loaddata_evalutate, echo = FALSE}
...
Information on further analysis that could be done, other workflows [can be linked as well](https://github.com/NESCent/popgenInfo/blob/master/use/DifferentiationSNP.html) (note the HTML as opposed to Rmd link).
