...
PCs.The statictic test for detecting outlier SNPs is the Mahalanobis distance
...
distribution of Fst for neutral marker. This distribution is used to assign
...
allows to calculate the appropriate input dataframe among other parameters FST
for each loci, and FST without sampling size correction (`FSTNoCorr`). Then the
