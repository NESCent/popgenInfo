...
This workflow will show you how to assess population differentiation with microsatellite/SSR data. We will analyse F-statistics, AMOVA, and Discriminant Analysis of Principal Components (DAPC). For this, we will utilize the *hierfstat*, *adegenet*, and *mmod* packages.
