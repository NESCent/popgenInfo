...
Populations are states. The function `basic.stats()`
...
You may now want to move into looking into population differentiation (See [Calculating genetic differentiation and clustering methods from microsatellites data](2015-12-15-microsatellite-differentiation.html))
