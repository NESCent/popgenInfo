...
```{r, data_import_FASTA_real, eval = TRUE}
...
To estimate if populations are significantly different, we will generate 100 replicates of the dataset using the function chao_bootstrap(). Then, summary statistics (meand and 95% CI) will be calculated for each of the different parameters of population differentiation. 
```{r, Fstats3}
