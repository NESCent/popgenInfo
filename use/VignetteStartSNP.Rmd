...
requires to work at population level. We will calculate: i) Genetic diversity,
ii) Test Hardy Weinberg  iii) Fis and global Fst.
...
locus <- Mydata[, -c(1,2,3,4,16:3086)] # We remove the extra columns and we keep only 20 SNP (to make calculation faster)  
...
#to convert genind object into a pegas loci object (i.e. dataframe)
...
basicstat
boot.ppfis(Mydata2) #confidence interval for Fis
