...
Jombart, with the function `find.clusters()` we used the maximum possible number of PCA
axis which is 20 here. See detailed tutorial on this method for more information
(https://github.com/thibautjombart/adegenet/raw/master/tutorials/tutorial-basics.pdf) In this example, we used
...
Four groups were finally detected and represented by the discriminant analysis.
...
You may now want to move to the [estimation of genetic
distances](2015-05-18-Dist-SNP.html)
  
# Contributors

- Stephanie Manel (Author)
- Zhian Kamvar (edits)
