...
To convert Mydata to a genind object (adegenet), the input should only contain
only genotypes. We decrease the number of snp to make the calculations faster
and keep only 20 SNPs in the object locus. We convert Mydata1 in a hierfstat
object (Mydata2)
...
distances](VignetteIndividualGeneticDistancesSNP.html)
