...
The "genind" object can then easily be converted into "hierfstat" (package *hierfstat*) and "loci" objects (package *pegas*).
...
Mydata3 <- genind2loci(Mydata1)      # Create loci object
```
