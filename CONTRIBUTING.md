...
6. Move your file into the **use** directory using `cp yourfilename.Rmd Your_branch_name/use/`.
...
11. To do a pull request, navigate to your branch on github. Click `Compare & review`. **(May be explain more here)**
