...
Recall that using git is analogous to keeping a good, detailed lab notebook. When
...
You can also see a summary of what you just did by looking at the summary of
your commit:
...
pushing these up to your fork. Once you are finished with all of your changes,
you can create a pull request from your GitHub fork to NESCent. After it's
reviewed by at least two of our maintainers, it gets merged into NESCent. From
here, you can checkout your master branch, fetch the changes from NESCent, merge
those changes, and push them up to the master branch on your fork to make it
even with NESCent.
