...
a few steps here because these are the steps you want to take when you create
a brand new branch and make sure it exists on your computer and on your fork:
...
push(repo, name = "origin", refspec = my_branch(BRANCH)) # 3
