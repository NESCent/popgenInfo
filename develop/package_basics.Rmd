...
imports from other packages (eg `importFrom("pegas", "amova")`). If you choose
to use modern tools such as [*roxygen2*
](http://cran.r-project.org/web/packages/roxygen2/vignettes/roxygen2.html), you
